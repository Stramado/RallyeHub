...
<body>
    ...
    <main>
        ...
        <section id="intro">
            <p>La présente politique de confidentialité décrit la manière dont le site <strong>RallyHub</strong> collecte, utilise et protège les données personnelles de ses utilisateurs. Elle s’inscrit dans le respect du <strong>Règlement Général sur la Protection des Données (RGPD – UE 2016/679)</strong> et de la <strong>loi Informatique et Libertés</strong>.</p>
        </section>
        ...
        <section id="responsable">
            ...
            <address>
                <strong>RallyHub – Projet Étudiant</strong><br>
        ...
        <section id="cookies">
            ...
            <p>RallyHub utilise des cookies techniques nécessaires au bon fonctionnement du site et des cookies tiers pour la lecture de vidéos intégrées ou l’analyse de trafic (YouTube, Google Analytics).</p>
        ...
        <section id="securite">
            ...
            <p>RallyHub met en œuvre des mesures techniques et organisationnelles pour garantir la sécurité et la confidentialité des données (chiffrement HTTPS, pare-feu, accès restreints aux bases de données, sauvegardes régulières).</p>
        </section>
